...
let modulePaths = {
 ...
 "example/example": "example.unsound.ddc",
 "packages/js/js": "packages/js/js.unsound.ddc",
 "packages/naver_maps_js2dart/src/generated/naver_map_core": "packages/naver_maps_js2dart/src/generated/naver_map_core.unsound.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'example.digests',
...
define("example.dart.bootstrap", ["example/example", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.example__example || app.example).main();
  var bootstrap = {
  ...
  dart_sdk.dart.trackLibraries("example.dart.bootstrap", {
    "example.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };
