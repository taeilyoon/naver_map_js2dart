define(['dart_sdk'], (function load__example__example(dart_sdk) {
  ...
  example.main = function main() {
    ...
    map.addListener("click", js.allowInterop(FunctionL(), dart.fn(e => {
      let t0;
  ...
  }, '{"version":3,"sourceRoot":"","sources":["example.dart"],"names":[],"mappings":";;;;;;;;;;;;;AAMM,cAAM,+BAAK,mBAAc,sBACzB;AAAc,kBAAS,kCAAO,YAAY;;;AAK3C,IAJH,AAAI,GAAD,aAAa,SAAS,6BAAa,QAAC;;AACjC,mBAAS,mCAAO,KAFlB,IAEkB;AAChB,iBAAM,GAAG;AACT,mGAAa,WAAF,CAAC;;;;AAEd,iBAAS,mCAAO,MANhB,IAMgB;AAChB,gBAAM,GAAG;AACT,qBAAW,kCAAO,YAAY;;;AACtB,IAAZ,WAAM;EACR","file":"example.unsound.ddc.js"}');
  // Exports:
  return {
